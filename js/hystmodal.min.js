! function(e) {
    ...
    function o(n) { if (t[n]) return t[n].exports; var i = t[n] = { i: n, l: !1, exports: {} }; return e[n].call(i.exports, i, i.exports, o), i.l = !0, i.exports }
    ...
    function n() { return (n = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var o = arguments[t]; for (var n in o) Object.prototype.hasOwnProperty.call(o, n) && (e[n] = o[n]) } return e }).apply(this, arguments) }
    ...
    var s = function() {
        function e(t) {
            ...
            this.config = n({ backscroll: !0, linkAttributeName: "data-hystmodal", closeOnOverlay: !0, closeOnEsc: !0, closeOnButton: !0, waitTransitions: !1, catchFocus: !0, fixedSelectors: "*[data-hystfixed]", beforeOpen: function() {}, afterClose: function() {} }, t), this.config.linkAttributeName && this.init(), this._closeAfterTransition = this._closeAfterTransition.bind(this)
        }
        var t, o, s;
        return t = e, (o = [{
            key: "init",
            ...
            value: function() {
                ...
                document.addEventListener("click", (function(t) {
                    ...
                    if (!e._isMoved && o) { t.preventDefault(), e.starter = o; var n = e.starter.getAttribute(e.config.linkAttributeName); return e._nextWindows = document.querySelector(n), void e.open() }
                    e.config.closeOnButton && t.target.closest("[data-hystclose]") && e.close()
                })), this.config.closeOnOverlay && (document.addEventListener("mousedown", (function(t) {!e._isMoved && t.target instanceof Element && !t.target.classList.contains("hystmodal__wrap") || (e._overlayChecker = !0) })), document.addEventListener("mouseup", (function(t) {
                    ...
                    e._overlayChecker = !1
                }))), window.addEventListener("keydown", (function(t) { if (!e._isMoved && e.config.closeOnEsc && 27 === t.which && e.isOpened) return t.preventDefault(), void e.close();!e._isMoved && e.config.catchFocus && 9 === t.which && e.isOpened && e.focusCatcher(t) }))
            }
        }, {
            key: "open",
            value: function(e) {
            ...
            value: function() {
                if (this.config.backscroll) {
                    ...
                    if (!0 === this.isOpened) return o.classList.remove("hystmodal__opened"), o.style.marginRight = "", t.forEach((function(e) { e.style.marginRight = "" })), window.scrollTo(0, this._scrollPosition), void(o.style.top = "");
                    this._scrollPosition = window.pageYOffset;
                    var n = window.innerWidth - o.clientWidth;
                    o.style.top = "".concat(-this._scrollPosition, "px"), n && (o.style.marginRight = "".concat(n, "px"), t.forEach((function(e) { e.style.marginRight = "".concat(parseInt(getComputedStyle(e).marginRight, 10) + n, "px") }))), o.classList.add("hystmodal__opened")
                }
            }
    ...
    try { o = o || new Function("return this")() } catch (e) { "object" == typeof window && (o = window) }
    e.exports = o
}, function(e, t) {
